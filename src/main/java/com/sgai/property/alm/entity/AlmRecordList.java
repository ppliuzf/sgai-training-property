...
/**
 * 
    * ClassName: AlmRecordList  
    * com.sgai.property.commonService.vo;(报警记录列表Entity)
    * @author 王天尧  
    * Date 2017年11月24日  
    * Company 首自信--智慧城市创新中心
 */
public class AlmRecordList extends BoEntity<AlmRecordList> {
	@ApiModelProperty(value = "主键")
	private static final long serialVersionUID = 1L;
	@ApiModelProperty(value = "报警记录编号")
	private String recordNum;		// record_num
	...
	private String emCode;		// 1.选项为:'Y':是'N':否默认为'Y'
	//非数据库字段
	private  String area;      //楼号code
	private  String equipmentCode;      //运行监控 设备编码
	private  String equipmentName;      //运行监控  设备名称
	...
	public AlmRecordList() {
		super();
	}

	public AlmRecordList(String id){
		super(id);
	}
	...
	@Length(min=0, max=10, message="record_num长度必须介于 0 和 10 之间")
