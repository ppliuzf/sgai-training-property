...
public class SurveyMainDetailVO implements Serializable {
    ...
    private List<SurveyQuestionVO> surveyQuestionVOs;
    ...
    public List<SurveyQuestionVO> getSurveyQuestionVOs() {
        return surveyQuestionVOs;
    }

    public void setSurveyQuestionVOs(List<SurveyQuestionVO> surveyQuestionVOs) {
