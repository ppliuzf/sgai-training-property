...
public class InventoriesParam {
    ...
    private List<InventoriesMatParam> matParamList;
    ...
    public List<InventoriesMatParam> getMatParamList() {
        return matParamList;
    }

    public void setMatParamList(List<InventoriesMatParam> matParamList) {
        this.matParamList = matParamList;
    }
}
