...
import com.sgai.property.depot.param.InventoriesWhMatParam;
...
//    private Date ivtExecEnd; //盘点结束时间
    ...
    private List<InventoriesWhMatVo> whMatVoList;
...
//    }
    ...
    public List<InventoriesWhMatVo> getWhMatVoList() {
        return whMatVoList;
    }

    public void setWhMatVoList(List<InventoriesWhMatVo> whMatVoList) {
        this.whMatVoList = whMatVoList;
    }
}
