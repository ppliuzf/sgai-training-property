...
public class InfoDetail extends BoEntity<InfoDetail> {
	...
	private Long presentTime; //服务器当前时间
	@ApiModelProperty(value = "发布范围字符串(部门(x人)、xxx、xxx)")
    private String infoScope;//发布范围字符串
	@ApiModelProperty(value = "发布范围(人员id)")
	private String infoScopeEmp;
	@ApiModelProperty(value = "发布范围(部门id)")
	private String infoScopeDept;
	@ApiModelProperty(value = "已回执数量")
    private Integer receiptcount;
    @ApiModelProperty(value = "未回执数量")
    private Integer nreceiptcount;
    @ApiModelProperty(value = "发布范围对象")
    private Long infoScopeObject; //发布范围对象
	...
	public String getInfoScopeEmp() {
		return infoScopeEmp;
	}

	public void setInfoScopeEmp(String infoScopeEmp) {
		this.infoScopeEmp = infoScopeEmp;
	}

	public String getInfoScopeDept() {
		return infoScopeDept;
	}

	public void setInfoScopeDept(String infoScopeDept) {
		this.infoScopeDept = infoScopeDept;
	}
	...
	public Integer getNreceiptcount() {
		return nreceiptcount;
	}

	public void setNreceiptcount(Integer nreceiptcount) {
		this.nreceiptcount = nreceiptcount;
	}

	public Long getInfoScopeObject() {
		return infoScopeObject;
	}

	public void setInfoScopeObject(Long infoScopeObject) {
