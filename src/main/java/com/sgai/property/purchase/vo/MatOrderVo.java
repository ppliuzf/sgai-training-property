...
public class MatOrderVo {
    ...
    @ApiModelProperty(value = "状态? 0:已撤回；1:待审核；2:已拒绝；3:已通过；4:采购中；5:已完成；6:已撤回")
    private Long orderStat; //状态? 0:已撤回；1:待审核；2:已拒绝；3:已通过；4:采购中；5:已完成；6:已撤回
    ...
    private List<MatDetailVo> matDetailVoList;

    @ApiModelProperty(value = "用料信息")
    private MatApplyDetailVo matApplyDetailVo;
    ...
    public List<MatDetailVo> getMatDetailVoList() {
        return matDetailVoList;
    }

    public void setMatDetailVoList(List<MatDetailVo> matDetailVoList) {
        this.matDetailVoList = matDetailVoList;
    }
	...
	public MatApplyDetailVo getMatApplyDetailVo() {
		return matApplyDetailVo;
	}

	public void setMatApplyDetailVo(MatApplyDetailVo matApplyDetailVo) {
		this.matApplyDetailVo = matApplyDetailVo;
	}
