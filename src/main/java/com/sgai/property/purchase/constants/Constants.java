package com.sgai.property.purchase.constants;
...
public class Constants {
    ...
    //1:已提交；2:已通过；3:已拒绝；4:已撤回 5:已领取
    public static final Long MT_STAT_1=1L;  //已提交
    public static final Long MT_STAT_2=2L;  //已通过
    public static final Long MT_STAT_3=3L;  //已拒绝
    public static final Long MT_STAT_4=4L;  //已撤回
    public static final Long MT_STAT_5=5L;  //已撤回
