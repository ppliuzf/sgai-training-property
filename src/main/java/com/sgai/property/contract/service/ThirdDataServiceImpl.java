...
public class ThirdDataServiceImpl {
    ...
    public String getNumber() {
        ...
        ResponseEntity<String> responseEntity = sendRequest(spaceListUrl, getLoginUser(), param);
    ...
    private LoginUser getLoginUser() {
        ...
        loginUser.setComCode(UserServletContext.getUserInfo().getCompanyId() + "");
