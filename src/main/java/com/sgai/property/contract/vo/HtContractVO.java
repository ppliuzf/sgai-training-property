...
public class HtContractVO{
    ...
    private List<GysSupplier> suppliers; //供应商
    ...
    public List<GysSupplier> getSuppliers() {
        return suppliers;
    }

    public void setSuppliers(List<GysSupplier> suppliers) {
