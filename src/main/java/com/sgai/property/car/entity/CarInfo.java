...
public class CarInfo extends BoEntity<CarInfo>{
    ...
    @ApiModelProperty(value = "车主手机号备用")
    private Long ciOwnerPhone2; //车主手机号备用
    @ApiModelProperty(value = "预约时间")
    private Long riUseEnd; //预约时间
    @ApiModelProperty(value = "部门ids")
    private List<String> ciDepartmentIds; //部门ids
    @ApiModelProperty(value = "手机号集")
    private List<Long> ciOwnerPhones; //手机号集

    @ApiModelProperty(value = "车辆行驶公里数")
    private Long journeyAmount;

    @ApiModelProperty(value = "上一次行驶里程数")
    private Long lastJourneyAmount;

    public Long getLastJourneyAmount() {
        return lastJourneyAmount;
    }

    public CarInfo setLastJourneyAmount(Long lastJourneyAmount) {
        this.lastJourneyAmount = lastJourneyAmount;
        return this;
    }
    ...
    public CarInfo setJourneyAmount(Long journeyAmount) {
   ...
   public void setCiOwnerPhone(Long ciOwnerPhone){  
    ...
    public List<Long> getCiOwnerPhones() {
        return ciOwnerPhones;
    }

    public void setCiOwnerPhones(List<Long> ciOwnerPhones) {
        this.ciOwnerPhones = ciOwnerPhones;
    }
}