package com.sgai.property.meeting.constants;
...
public class Constants {
    public static final String J2CACHE_CHANNEL_NAME="meeting";
	public static final String TOKEN_KEY_PREFIX = "bjfzx:accessToken:";
	public final static String REDIS_KEY_ORGAN_KEY = "qitoon:meetings:organ:key";
	public static final String BIZ_MT_REMIND_MIN = "BIZ_MT_REMIND_MIN";
    ...
    //2 未开始 1执行中 4已结束 4已逾期3已取消
    public static final Integer MT_STATUS_2=2;  //未开始
    public static final Integer MT_STATUS_1=1;  //执行中
    public static final Integer MT_STATUS_4=4;  //已结束
    public static final Integer MT_STATUS_5=5;  //已逾期
    public static final Integer MT_STATUS_3=3;  //已取消
    ...
    public static final class RoomUserStatus{
        ...
        public static final Integer Nome = 2;
    }
    ...
    public static final class SqlString{
        ...
        public static final String CreateTimeDesc = " CREATE_TIME DESC ";
    }
