...
public class TemplateVo extends BaseVo{
    ...
    @ApiModelProperty(value = "科目费项关联列表")
    List<TemplateSubjectItem> subjectItemList;
   ...
   public void setOrgId(String orgId){  
	...
	public List<TemplateSubjectItem> getSubjectItemList() {
		return subjectItemList;
	}
	
	public void setSubjectItemList(List<TemplateSubjectItem> subjectItemList) {
