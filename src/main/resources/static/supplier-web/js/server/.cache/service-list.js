/*TMODJS:{"version":1,"md5":"5a39fd1c0a7576d3b8dbdc67fc6dad8d"}*/
template('service-list',function($data,$filename
/*``*/) {
...
$out+='">';
$out+=$escape(item.count);
$out+='</div> </td>     <!--<li><a href="./service-compile.html?id=';
$out+=$escape(item.id);
$out+='" class="underline js-edit" data-id="">编辑</a></li>--> <!--';
if(item.isDelete !== 3){
...
$out+='-->    <td class="text-center"> <a href="./service-compile.html?id=';
$out+=$escape(item.id);
