...
$each(supplierNames,function(supplier,$index){
$out+=' ';
if(supplierNames.length){
$out+=' ';
if(supplier === supplierNames[supplierNames.length-1]){
...
$out+=' </div> <style> /*p{*/ /*word-wrap:break-word;*/ /*word-break : break-all;*/ /*}*/ /*.desc{*/ /*max-width: 1135px;*/ /*}*/ /*.di-box {*/ /*float: left;*/ /*width: 84px;*/ /*height: 84px;*/ /*margin-right: 20px;*/ /*text-align: center;*/ /*margin-bottom: 30px;*/ /*}*/ /*.di-box img {*/ /*width: 100%;*/ /*height: 100%;*/ /*}*/ /*.di-box a{*/ /*display: block;*/ /*width: 84px;*/ /*height: 84px;*/ /*}*/ /*.di-box a img {*/ /*width: 100%;*/ /*}*/ /*.WW{*/ /*font-weight: 700;*/ /*}*/ </style>';
