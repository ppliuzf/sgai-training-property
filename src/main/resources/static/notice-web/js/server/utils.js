(function ($) {
    ...
    //  else {
    //     var tokens = 'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJqd3QiLCJpYXQiOjE1MzAyODI2NjcsInN1YiI6IntcImNvbU5hbWVcIjpcIueZvem5remhueebrue7hFwiLFwidXNlclR5cGVcIjpcIklcIixcImNvbUNvZGVcIjpcImJhaWx1XCIsXCJ1c2VyTmFtZVwiOlwi5byg5L-K5riFXCIsXCJlbUNvZGVcIjpcInpoYW5nanVucWluXCIsXCJ1c2VySWRcIjpcInVzZXIwMVwiLFwiZGVwdENvZGVcIjpcImhvdXRhaVwifSIsImV4cCI6MTUzMDMyNTg2N30.kkm2i2Imgqzw7LLKCpBUYpgcGT7aQBem71c_h2pTTY8';
        ...
        getData: function (config, callback, error) {
            var setting = {
                ...
                headers: {
                    ...
                    //'accessToken': 'PC_eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJqd3QiLCJpYXQiOjE1Mjk1NjMwNjIsInN1YiI6IntcInVzZXJUeXBlXCI6XCJJXCIsXCJjb21Db2RlXCI6XCJzazAwMVwiLFwidXNlck5hbWVcIjpcInNrdXNlcjEwXCIsXCJ1c2VySWRcIjpcInNrdXNlcjEwXCJ9IiwiZXhwIjoxNTI5NjA2MjYyfQ.X5h-ksd3tASHQi0pfcv0ROAMVdkNhg0G15Dkx5pYXkU'
        ...
        instantSearch: function (config) {
            ...
            $(opt.el).each(function () {
                ...
                $(this).html(template('common/instant-search', {
                    placeholder: opt.placeholder,
                    approvalEmpName: opt.default.approvalEmpName,
                    approvalEmpId: JSON.stringify({id:opt.default.approvalEmpId,title:opt.default.approvalEmpName})
                }));
                $inp.off('keyup keydown keypress input').on('keyup keydown keypress input', function () {
                    $inp.removeClass(opt.loadingClass);
                    var v = $.trim($inp.val());
