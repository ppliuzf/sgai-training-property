...
function(e, t) {
	...
	function e(e, t) {
		...
		if (e) if ("string" == typeof e) {
			...
			if (r.indexOf("<") >= 0 && r.indexOf(">") >= 0) {
				var l = "div";
				for (0 === r.indexOf("<li") && (l = "ul"), 0 === r.indexOf("<tr") && (l = "tbody"), 0 !== r.indexOf("<td") && 0 !== r.indexOf("<th") || (l = "tr"), 0 === r.indexOf("<tbody") && (l = "table"), 0 === r.indexOf("<option") && (l = "select"), (n = document.createElement(l)).innerHTML = r, i = 0; i < n.childNodes.length; i += 1) a.push(n.childNodes[i])
	...
	var n, r = n = "undefined" == typeof window ? {
		navigator: {
			userAgent: ""
		},
		location: {},
	...
	e.fn = o.prototype, e.Class = o, e.use = function() {
		for (var t = [], a = arguments.length; a--;) t[a] = arguments[a];
		t.forEach(function(t) {
			var a = "__utils" in t;
			Object.keys(t).forEach(function(i) {
				"__utils" !== i && (a ? e[i] = t[i] : e.fn[i] = t[i])
			})
		})
	};
	for (var l = {
		...
		prop: function(e, t) {
			var a = arguments,
				i = this;
			if (1 !== arguments.length || "string" != typeof e) {
				for (var s = 0; s < this.length; s += 1) if (2 === a.length) i[s][e] = t;
				else for (var n in e) i[s][n] = e[n];
				return this
			}
		...
		dataset: function() {
			...
			if (e) {
				...
				else for (var s = 0; s < e.attributes.length; s += 1) {
					var n = e.attributes[s];
		...
		val: function(e) {
			var t = this; {
				if (void 0 !== e) {
					for (var a = 0; a < this.length; a += 1) t[a].value = e;
					return this
				}
				if (this[0]) {
					if (this[0].multiple && "select" === this[0].nodeName.toLowerCase()) {
						for (var i = [], s = 0; s < this[0].selectedOptions.length; s += 1) i.push(t[0].selectedOptions[s].value);
						return i
					}
					return this[0].value
				}
		...
		on: function() {
			function t(t) {
				...
				if (a) {
					...
					if (i.unshift(t), e(a).is(r)) o.apply(a, i);
					else for (var s = e(a).parents(), n = 0; n < s.length; n += 1) e(s[n]).is(r) && o.apply(s[n], i)
				}
			}
			function a(e) {
			...
			var r, o, l = s[0],
				d = !1;
			"function" == typeof s[1] ? (r = !1, o = s[1], d = s[2]) : (r = s[1], o = s[2], d = s[3]);
			for (var c, p = l.split(" "), u = 0; u < this.length; u += 1) {
				var h = i[u];
				if (r) for (c = 0; c < p.length; c += 1) h.dom7LiveListeners || (h.dom7LiveListeners = []), h.dom7LiveListeners.push({
					type: l,
					listener: o,
					proxyListener: t
				}), h.addEventListener(p[c], t, d);
				else for (c = 0; c < p.length; c += 1) h.dom7Listeners || (h.dom7Listeners = []), h.dom7Listeners.push({
					type: l,
					listener: o,
					proxyListener: a
		...
		off: function() {
			...
			var i, s, n = t[0],
				r = !1;
			"function" == typeof t[1] ? (i = !1, s = t[1], r = t[2]) : (i = t[1], s = t[2], r = t[3]);
			for (var o = n.split(" "), l = 0; l < o.length; l += 1) for (var d = 0; d < this.length; d += 1) {
				var c = e[d];
				if (i) {
					if (c.dom7LiveListeners) for (var p = 0; p < c.dom7LiveListeners.length; p += 1) s ? c.dom7LiveListeners[p].listener === s && c.removeEventListener(o[l], c.dom7LiveListeners[p].proxyListener, r) : c.dom7LiveListeners[p].type === o[l] && c.removeEventListener(o[l], c.dom7LiveListeners[p].proxyListener, r)
		...
		once: function(e, t, a, i) {
			function s(r) {
				var o = r.target.dom7EventData || [];
				a.apply(this, o), n.off(e, t, s, i)
			}
			var n = this;
			return "function" == typeof t && (a = arguments[1], i = arguments[2], t = !1), n.on(e, t, s, i)
		},
		trigger: function() {
			for (var e = this, t = [], a = arguments.length; a--;) t[a] = arguments[a];
		...
		hide: function() {
			for (var e = this, t = 0; t < this.length; t += 1) e[t].style.display = "none";
			return this
		},
		show: function() {
		...
		toArray: function() {
			for (var e = this, t = [], a = 0; a < this.length; a += 1) t.push(e[a]);
			return t
		},
		each: function(e) {
			var t = this;
		...
		forEach: function(e) {
			var t = this;
			if (!e) return this;
			for (var a = 0; a < this.length; a += 1) if (!1 === e.call(t[a], t[a], a)) return t;
			return this
		},
		filter: function(e) {
			for (var t = [], a = this, i = 0; i < a.length; i += 1) e.call(a[i], i, a[i]) && t.push(a[i]);
			return new o(t)
		},
		map: function(e) {
			for (var t = [], a = this, i = 0; i < a.length; i += 1) t.push(e.call(a[i], i, a[i]));
			return new o(t)
		},
		html: function(e) {
			var t = this;
		...
		indexOf: function(e) {
			for (var t = this, a = 0; a < this.length; a += 1) if (t[a] === e) return a
		},
		index: function() {
			var e, t = this[0];
			if (t) {
		...
		eq: function(e) {
			if (void 0 === e) return this;
			var t, a = this.length;
			return e > a - 1 ? new o([]) : e < 0 ? (t = a + e, new o(t < 0 ? [] : [this[t]])) : new o([this[e]])
		},
		append: function() {
			for (var e = this, t = [], a = arguments.length; a--;) t[a] = arguments[a];
			for (var i, s = 0; s < t.length; s += 1) {
				...
				for (var n = 0; n < this.length; n += 1) if ("string" == typeof i) {
					...
					for (r.innerHTML = i; r.firstChild;) e[n].appendChild(r.firstChild)
				} else if (i instanceof o) for (var l = 0; l < i.length; l += 1) e[n].appendChild(i[l]);
		...
		prepend: function(e) {
			...
			} else if (e instanceof o) for (a = 0; a < e.length; a += 1) i[t].insertBefore(e[a], i[t].childNodes[0]);
		...
		insertBefore: function(t) {
			for (var a = this, i = e(t), s = 0; s < this.length; s += 1) if (1 === i.length) i[0].parentNode.insertBefore(a[s], i[0]);
			else if (i.length > 1) for (var n = 0; n < i.length; n += 1) i[n].parentNode.insertBefore(a[s].cloneNode(!0), i[n])
		},
		insertAfter: function(t) {
			for (var a = this, i = e(t), s = 0; s < this.length; s += 1) if (1 === i.length) i[0].parentNode.insertBefore(a[s], i[0].nextSibling);
			else if (i.length > 1) for (var n = 0; n < i.length; n += 1) i[n].parentNode.insertBefore(a[s].cloneNode(!0), i[n].nextSibling)
		},
		next: function(t) {
		...
		prev: function(t) {
			if (this.length > 0) {
				var a = this[0];
				return new o(t ? a.previousElementSibling && e(a.previousElementSibling).is(t) ? [a.previousElementSibling] : [] : a.previousElementSibling ? [a.previousElementSibling] : [])
			}
			return new o([])
		},
		prevAll: function(t) {
		...
		children: function(a) {
			for (var i = this, s = [], n = 0; n < this.length; n += 1) for (var r = i[n].childNodes, l = 0; l < r.length; l += 1) a ? 1 === r[l].nodeType && e(r[l]).is(a) && s.push(r[l]) : 1 === r[l].nodeType && s.push(r[l]);
			return new o(t(s))
		},
		remove: function() {
		...
		empty: function() {
			for (var e = this, t = 0; t < this.length; t += 1) {
				var a = e[t];
				if (1 === a.nodeType) {
					for (var i = 0; i < a.childNodes.length; i += 1) a.childNodes[i].parentNode && a.childNodes[i].parentNode.removeChild(a.childNodes[i]);
					a.textContent = ""
				}
			}
			return this
		}
	}, d = "click blur focus focusin focusout keyup keydown keypress submit change mousedown mousemove mouseup mouseenter mouseleave mouseout mouseover touchstart touchend touchmove resize scroll".split(" "), c = "resize scroll".split(" "), p = 0; p < d.length; p += 1)!
	function(t) {
		l[t] = function(a, i, s) {
			var n = this;
			if (void 0 === a) {
				for (var r = 0; r < this.length; r += 1) c.indexOf(t) < 0 && (t in n[r] ? n[r][t]() : e(n[r]).trigger(t));
				return this
			}
			return this.on(t, a, i, s)
		}
	}(d[p]);
	e.use(l);
	var u = {
		...
		extend: function() {
			...
			for (var a = Object(e[0]), i = 1; i < e.length; i += 1) {
				...
				if (void 0 !== s && null !== s) for (var n = Object.keys(Object(s)), r = 0, o = n.length; r < o; r += 1) {
					...
					void 0 !== d && d.enumerable && (u.isObject(a[l]) && u.isObject(s[l]) ? u.extend(a[l], s[l]) : !u.isObject(a[l]) && u.isObject(s[l]) ? (a[l] = {}, u.extend(a[l], s[l])) : a[l] = s[l])
				}
			}
			return a
		}
	...
	f.prototype.on = function(e, t) {
		...
		for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
		var a, i, s, n = this;
		return "string" == typeof e[0] || Array.isArray(e[0]) ? (a = e[0], i = e.slice(1, e.length), s = n) : (a = e[0].events, i = e[0].data, s = e[0].context || n), (Array.isArray(a) ? a : a.split(" ")).forEach(function(e) {
			n.eventsListeners[e] && n.eventsListeners[e].forEach(function(e) {
				e.apply(s, i)
			})
		}), n
		...
		var s = e.name || Object.keys(i.prototype.modules).length + "_" + u.now();
	...
	var m = {
		...
		updateSlides: function() {
			...
			var h = e.slides.length,
				...
				y = 0;
			if (void 0 !== i) {
				"string" == typeof m && m.indexOf("%") >= 0 && (m = parseFloat(m.replace("%", "")) / 100 * i), e.virtualSize = -m, s ? r.css({
					marginLeft: "",
					marginTop: ""
				}) : r.css({
					marginRight: "",
				...
				var w;
				t.slidesPerColumn > 1 && (w = Math.floor(r.length / t.slidesPerColumn) === r.length / e.params.slidesPerColumn ? r.length : Math.ceil(r.length / t.slidesPerColumn) * t.slidesPerColumn, "auto" !== t.slidesPerView && "row" === t.slidesPerColumnFill && (w = Math.max(w, t.slidesPerView * t.slidesPerColumn)));
				for (var x, T = t.slidesPerColumn, E = w / T, S = E - (t.slidesPerColumn * E - r.length), C = 0; C < r.length; C += 1) {
					x = 0;
					var M = r.eq(C);
					if (t.slidesPerColumn > 1) {
						var z = void 0,
							P = void 0,
							k = void 0;
						"column" === t.slidesPerColumnFill ? (k = C - (P = Math.floor(C / T)) * T, (P > S || P === S && k === T - 1) && (k += 1) >= T && (k = 0, P += 1), z = P + k * w / T, M.css({
							"-webkit-box-ordinal-group": z,
							"-moz-box-ordinal-group": z,
							"-ms-flex-order": z,
							"-webkit-order": z,
							order: z
						})) : P = C - (k = Math.floor(C / E)) * E, M.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== k && t.spaceBetween && t.spaceBetween + "px").attr("data-swiper-column", P).attr("data-swiper-row", k)
					}
					"none" !== M.css("display") && ("auto" === t.slidesPerView ? (x = e.isHorizontal() ? M.outerWidth(!0) : M.outerHeight(!0), t.roundLengths && (x = Math.floor(x))) : (x = (i - (t.slidesPerView - 1) * m) / t.slidesPerView, t.roundLengths && (x = Math.floor(x)), e.isHorizontal() ? r[C].style.width = x + "px" : r[C].style.height = x + "px"), r[C].swiperSlideSize = x, d.push(x), t.centeredSlides ? (g = g + x / 2 + b / 2 + m, 0 === b && 0 !== C && (g = g - i / 2 - m), 0 === C && (g = g - i / 2 - m), Math.abs(g) < .001 && (g = 0), y % t.slidesPerGroup == 0 && o.push(g), l.push(g)) : (y % t.slidesPerGroup == 0 && o.push(g), l.push(g), g = g + x + m), e.virtualSize += x + m, b = x, y += 1)
				}
				e.virtualSize = Math.max(e.virtualSize, i) + p;
				var I;
				if (s && n && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
					width: e.virtualSize + t.spaceBetween + "px"
				}), e.support.flexbox && !t.setWrapperSize || (e.isHorizontal() ? a.css({
					width: e.virtualSize + t.spaceBetween + "px"
				}) : a.css({
					height: e.virtualSize + t.spaceBetween + "px"
				})), t.slidesPerColumn > 1 && (e.virtualSize = (x + t.spaceBetween) * w, e.virtualSize = Math.ceil(e.virtualSize / t.slidesPerColumn) - t.spaceBetween, e.isHorizontal() ? a.css({
					width: e.virtualSize + t.spaceBetween + "px"
				}) : a.css({
					height: e.virtualSize + t.spaceBetween + "px"
				}), t.centeredSlides)) {
					I = [];
					for (var $ = 0; $ < o.length; $ += 1) o[$] < e.virtualSize + o[0] && I.push(o[$]);
					o = I
				}
				if (!t.centeredSlides) {
					I = [];
					for (var L = 0; L < o.length; L += 1) o[L] <= e.virtualSize - i && I.push(o[L]);
					o = I, Math.floor(e.virtualSize - i) - Math.floor(o[o.length - 1]) > 1 && o.push(e.virtualSize - i)
				}
				0 === o.length && (o = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? s ? r.css({
					marginLeft: m + "px"
				}) : r.css({
					marginRight: m + "px"
				}) : r.css({
					...
					slidesGrid: l,
					slidesSizesGrid: d
				}), r.length !== h && e.emit("slidesLengthChange"), o.length !== f && e.emit("snapGridLengthChange"), l.length !== v && e.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && e.updateSlidesOffset()
			}
		},
		...
		updateProgress: function(e) {
			...
			var t = this,
				...
				o = n,
				l = r;
			0 === i ? (s = 0, n = !0, r = !0) : (n = (s = (e - t.minTranslate()) / i) <= 0, r = s >= 1), u.extend(t, {
				progress: s,
				isBeginning: n,
				isEnd: r
			}), (a.watchSlidesProgress || a.watchSlidesVisibility) && t.updateSlidesProgress(e), n && !o && t.emit("reachBeginning toEdge"), r && !l && t.emit("reachEnd toEdge"), (o && !n || l && !r) && t.emit("fromEdge"), t.emit("progress", s)
		},
		...
		updateSlidesClasses: function() {
			...
			var r = t.eq(s);
			r.addClass(a.slideActiveClass), a.loop && (r.hasClass(a.slideDuplicateClass) ? i.children("." + a.slideClass + ":not(." + a.slideDuplicateClass + ')[data-swiper-slide-index="' + n + '"]').addClass(a.slideDuplicateActiveClass) : i.children("." + a.slideClass + "." + a.slideDuplicateClass + '[data-swiper-slide-index="' + n + '"]').addClass(a.slideDuplicateActiveClass));
			var o = r.next("." + a.slideClass).addClass(a.slideNextClass);
			a.loop && 0 === o.length && (o = t.eq(0)).addClass(a.slideNextClass);
			var l = r.prev("." + a.slideClass).addClass(a.slidePrevClass);
		...
		updateActiveIndex: function() {
			for (var e, t, a = this, i = a.rtl ? a.translate : -a.translate, s = a.slidesGrid, n = a.snapGrid, r = a.params, o = a.activeIndex, l = 0; l < s.length; l += 1) void 0 !== s[l + 1] ? i >= s[l] && i < s[l + 1] - (s[l + 1] - s[l]) / 2 ? e = l : i >= s[l] && i < s[l + 1] && (e = l + 1) : i >= s[l] && (e = l);
			r.normalizeSlideIndex && (e < 0 || void 0 === e) && (e = 0), (t = Math.floor(e / r.slidesPerGroup)) >= n.length && (t = n.length - 1), e !== o && (u.extend(a, {
				snapIndex: t,
				previousIndex: o,
				activeIndex: e
			}), a.emit("aciveIndexChange"), a.emit("snapIndexChange"))
		},
		updateClickedSlide: function(t) {
			...
			if (!s || !n) return a.clickedSlide = void 0, void(a.clickedIndex = void 0);
		...
		g = {
			...
			setTranslate: function(e, t) {
				var a = this,
					...
					o = 0,
					l = 0;
				a.isHorizontal() ? o = i ? -e : e : l = e, s.roundLengths && (o = Math.floor(o), l = Math.floor(l)), s.virtualTranslate || (h.transforms3d ? n.transform("translate3d(" + o + "px, " + l + "px, 0px)") : n.transform("translate(" + o + "px, " + l + "px)")), a.translate = a.isHorizontal() ? o : l;
		...
		b = {
			...
			transitionStart: function(e) {
				...
				var t = this,
					...
					i = t.params,
					s = t.previousIndex;
				i.autoHeight && t.updateAutoHeight(), t.emit("transitionStart"), e && a !== s && (t.emit("slideChangeStart"), a > s ? t.emit("slideNextStart") : t.emit("slidePrevStart"))
			},
			transitionEnd: function(e) {
				void 0 === e && (e = !0);
				var t = this,
		...
		w = {
			...
			slideNext: function(e, t, a) {
				...
				var i = this,
					s = i.params,
					n = i.animating;
				return s.loop ? !n && (i.loopFix(), i.slideTo(i.activeIndex + s.slidesPerGroup, e, t, a)) : i.slideTo(i.activeIndex + s.slidesPerGroup, e, t, a)
			},
			slidePrev: function(e, t, a) {
				...
				var i = this,
					s = i.params,
					n = i.animating;
				return s.loop ? !n && (i.loopFix(), i.slideTo(i.activeIndex - 1, e, t, a)) : i.slideTo(i.activeIndex - 1, e, t, a)
			},
			...
			slideToClickedSlide: function() {
				...
				if (i.loop) {
					...
					t = parseInt(e(a.clickedSlide).attr("data-swiper-slide-index"), 10), i.centeredSlides ? r < a.loopedSlides - n / 2 || r > a.slides.length - a.loopedSlides + n / 2 ? (a.loopFix(), r = s.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), u.nextTick(function() {
						a.slideTo(r)
					})) : a.slideTo(r) : r > a.slides.length - n ? (a.loopFix(), r = s.children("." + i.slideClass + '[data-swiper-slide-index="' + t + '"]:not(.' + i.slideDuplicateClass + ")").eq(0).index(), u.nextTick(function() {
						a.slideTo(r)
					})) : a.slideTo(r)
				} else a.slideTo(r)
			}
		...
		x = {
			loopCreate: function() {
				...
				s.each(function(a, i) {
					var n = e(i);
					a < t.loopedSlides && d.push(i), a < s.length && a >= s.length - t.loopedSlides && l.push(i), n.attr("data-swiper-slide-index", a)
				});
			...
			loopFix: function() {
				var e, t = this,
					...
					s = t.slides,
					n = t.loopedSlides;
				i < n ? (e = s.length - 3 * n + i, e += n, t.slideTo(e, 0, !1, !0)) : ("auto" === a.slidesPerView && i >= 2 * n || i > s.length - 2 * a.slidesPerView) && (e = -s.length + i + n, e += n, t.slideTo(e, 0, !1, !0))
			},
		...
		T = {
			setGrabCursor: function(e) {
				var t = this;
				if (!h.touch && t.params.simulateTouch) {
					var a = t.el;
		...
		E = {
			appendSlide: function(e) {
				var t = this,
					a = t.$wrapperEl,
					i = t.params;
				if (i.loop && t.loopDestroy(), "object" == typeof e && e.length) for (var s = 0; s < e.length; s += 1) e[s] && a.append(e[s]);
				else a.append(e);
			...
			prependSlide: function(e) {
				...
				a.loop && t.loopCreate(), a.observer && h.observer || t.update(), t.slideTo(n, 0, !1)
			},
			removeSlide: function(e) {
				...
				a.loop && t.loopCreate(), a.observer && h.observer || t.update(), a.loop ? t.slideTo(r + t.loopedSlides, 0, !1) : t.slideTo(r, 0, !1)
			},
		...
		C = function(t) {
			var a = this,
				...
				n = a.touches,
				r = t;
			if (r.originalEvent && (r = r.originalEvent), i.isTouchEvent = "touchstart" === r.type, i.isTouchEvent || !("which" in r) || 3 !== r.which) if (s.noSwiping && e(r).closest("." + s.noSwipingClass)[0]) a.allowClick = !0;
				...
				var o = n.currentX,
					l = n.currentY;
				if (!(S.ios && s.iOSEdgeSwipeDetection && o <= s.iOSEdgeSwipeThreshold)) {
					if (u.extend(i, {
						isTouched: !0,
						isMoved: !1,
						...
						isScrolling: void 0,
						startMoving: void 0
					}), n.startX = o, n.startY = l, i.touchStartTime = u.now(), a.allowClick = !0, a.updateSize(), a.swipeDirection = void 0, s.threshold > 0 && (i.allowThresholdMove = !1), "touchstart" !== r.type) {
						var d = !0;
		...
		M = function(t) {
			...
			if (o.originalEvent && (o = o.originalEvent), !i.isTouchEvent || "mousemove" !== o.type) {
				...
				if (!a.allowTouchMove) return a.allowClick = !1, void(i.isTouched && (u.extend(n, {
					startX: l,
					startY: d,
					currentX: l,
					currentY: d
				...
				if (i.allowTouchCallbacks && a.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
					if (n.currentX = "touchmove" === o.type ? o.targetTouches[0].pageX : o.pageX, n.currentY = "touchmove" === o.type ? o.targetTouches[0].pageY : o.pageY, void 0 === i.isScrolling) {
						var c;
						a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : (c = 180 * Math.atan2(Math.abs(n.currentY - n.startY), Math.abs(n.currentX - n.startX)) / Math.PI, i.isScrolling = a.isHorizontal() ? c > s.touchAngle : 90 - c > s.touchAngle)
					}
					if (i.isScrolling && a.emit("touchMoveOpposite", o), "undefined" == typeof startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isTouched) if (i.isScrolling) i.isTouched = !1;
						...
						var p = a.isHorizontal() ? n.currentX - n.startX : n.currentY - n.startY;
						n.diff = p, p *= s.touchRatio, r && (p = -p), a.swipeDirection = p > 0 ? "prev" : "next", i.currentTranslate = p + i.startTranslate;
						var h = !0,
							f = s.resistanceRatio;
		...
		z = function(e) {
			...
			if (d.originalEvent && (d = d.originalEvent), a.allowTouchCallbacks && t.emit("touchEnd", d), a.allowTouchCallbacks = !1, a.isTouched) {
				...
				if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap", d), p < 300 && c - a.lastClickTime > 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), a.clickTimeout = u.nextTick(function() {
					t && t.emit("click", d)
				}, 300)), p < 300 && c - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), t.emit("doubleTap", d))), a.lastClickTime = u.now(), u.nextTick(function() {
					t && (t.allowClick = !0)
					...
					if (i.freeModeMomentum) {
						if (a.velocities.length > 1) {
							var f = a.velocities.pop(),
								...
								g = f.time - v.time;
							t.velocity = m / g, t.velocity /= 2, Math.abs(t.velocity) < i.freeModeMinimumVelocity && (t.velocity = 0), (g > 150 || u.now() - f.time > 300) && (t.velocity = 0)
						} else t.velocity = 0;
						...
						if (w < t.maxTranslate()) i.freeModeMomentumBounce ? (w + t.maxTranslate() < -E && (w = t.maxTranslate() - E), x = t.maxTranslate(), T = !0, a.allowMomentumBounce = !0) : w = t.maxTranslate();
						else if (w > t.minTranslate()) i.freeModeMomentumBounce ? (w - t.minTranslate() > E && (w = t.minTranslate() + E), x = t.minTranslate(), T = !0, a.allowMomentumBounce = !0) : w = t.minTranslate();
						else if (i.freeModeSticky) {
							for (var S, C = 0; C < l.length; C += 1) if (l[C] > -w) {
								S = C;
								break
							}
							w = Math.abs(l[S] - w) < Math.abs(l[S - 1] - w) || "next" === t.swipeDirection ? l[S] : l[S - 1], n || (w = -w)
						}
						if (0 !== t.velocity) b = n ? Math.abs((-w - t.translate) / t.velocity) : Math.abs((w - t.translate) / t.velocity);
						else if (i.freeModeSticky) return void t.slideReset();
						i.freeModeMomentumBounce && T ? (t.updateProgress(x), t.setTransition(b), t.setTranslate(w), t.transitionStart(), t.animating = !0, r.transitionEnd(function() {
							t && a.allowMomentumBounce && (t.emit("momentumBounce"), t.setTransition(i.speed), t.setTranslate(x), r.transitionEnd(function() {
								t && t.transitionEnd()
							}))
						})) : t.velocity ? (t.updateProgress(w), t.setTransition(b), t.setTranslate(w), t.transitionStart(), t.animating || (t.animating = !0, r.transitionEnd(function() {
							t && t.transitionEnd()
						}))) : t.updateProgress(w), t.updateActiveIndex(), t.updateSlidesClasses(), t.updateRealIndex()
					}(!i.freeModeMomentum || p >= i.longSwipesMs) && (t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), t.updateRealIndex())
				} else {
		...
		P = function() {
			...
			if (!a || 0 !== a.offsetWidth) {
				if (t.breakpoints && e.setBreakpoint(), e.allowSlideNext = !0, e.allowSlidePrev = !0, e.updateSize(), e.updateSlides(), t.freeMode) {
					...
					e.setTranslate(n), e.updateActiveIndex(), e.updateSlidesClasses(), e.updateRealIndex(), t.autoHeight && e.updateAutoHeight()
			...
			events: {
				attachEvents: function() {
					var e = this,
						...
						i = e.el,
						s = e.wrapperEl;
					e.onTouchStart = C.bind(e), e.onTouchMove = M.bind(e), e.onTouchEnd = z.bind(e), e.onClick = k.bind(e);
					var n = "container" === t.touchEventsTarget ? i : s,
						r = !! t.nested;
					if (y.ie) n.addEventListener(a.start, e.onTouchStart, !1), (h.touch ? n : document).addEventListener(a.move, e.onTouchMove, r), (h.touch ? n : document).addEventListener(a.end, e.onTouchEnd, !1);
					else {
						if (h.touch) {
							var o = !("onTouchStart" !== a.start || !h.passiveListener || !t.passiveListeners) && {
								passive: !0,
								capture: !1
							};
						...
						}(t.simulateTouch && !S.ios && !S.android || t.simulateTouch && !h.touch && S.ios) && (n.addEventListener("mousedown", e.onTouchStart, !1), document.addEventListener("mousemove", e.onTouchMove, r), document.addEventListener("mouseup", e.onTouchEnd, !1))
					}(t.preventClicks || t.preventClicksPropagation) && n.addEventListener("click", e.onClick, !0), e.on("resize observerUpdate", P)
				},
				detachEvents: function() {
					var e = this,
						...
						r = !! t.nested;
					if (y.ie) n.removeEventListener(a.start, e.onTouchStart, !1), (h.touch ? n : document).removeEventListener(a.move, e.onTouchMove, r), (h.touch ? n : document).removeEventListener(a.end, e.onTouchEnd, !1);
					else {
						if (h.touch) {
							var o = !("onTouchStart" !== a.start || !h.passiveListener || !t.passiveListeners) && {
								passive: !0,
						...
						}(t.simulateTouch && !S.ios && !S.android || t.simulateTouch && !h.touch && S.ios) && (n.removeEventListener("mousedown", e.onTouchStart, !1), document.removeEventListener("mousemove", e.onTouchMove, r), document.removeEventListener("mouseup", e.onTouchEnd, !1))
					}(t.preventClicks || t.preventClicksPropagation) && n.removeEventListener("click", e.onClick, !0), e.off("resize observerUpdate", P)
				}
			},
			breakpoints: {
				setBreakpoint: function() {
					...
					if (n && (!n || 0 !== Object.keys(n).length)) {
						...
						if (r && e.currentBreakpoint !== r) {
							...
							if (u.extend(e.params, o), u.extend(e, {
			...
			classes: {
				addClasses: function() {
					var e = this,
						...
						s = e.$el,
						n = [];
					n.push(a.direction), a.freeMode && n.push("free-mode"), h.flexbox || n.push("no-flexbox"), a.autoHeight && n.push("autoheight"), i && n.push("rtl"), a.slidesPerColumn > 1 && n.push("multirow"), S.android && n.push("android"), S.ios && n.push("ios"), (r.navigator.pointerEnabled || r.navigator.msPointerEnabled) && n.push("wp8-" + a.direction), n.forEach(function(e) {
		...
		L = function(t) {
			function a() {
				...
				o || (o = {}), o = u.extend({}, o), n && !o.el && (o.el = n), t.call(this, o), Object.keys($).forEach(function(e) {
				...
				var d = this,
					c = u.extend({}, I);
				d.useModulesParams(c), d.params = u.extend({}, c, o), d.originalParams = u.extend({}, d.params), d.passedParams = u.extend({}, o);
				var p = e(d.params.el);
				if (n = p[0]) {
					if (p.length > 1) {
						var f = [];
					...
					var v = p.children("." + d.params.wrapperClass);
					return u.extend(d, {
						$el: p,
						el: n,
						$wrapperEl: v,
						...
						rtl: "horizontal" === d.params.direction && ("rtl" === n.dir.toLowerCase() || "rtl" === p.css("direction")),
						...
						touchEvents: function() {
							...
							return r.navigator.pointerEnabled ? t = ["pointerdown", "pointermove", "pointerup"] : r.navigator.msPointerEnabled && (t = ["MSPointerDown", "MsPointerMove", "MsPointerUp"]), {
								start: h.touch || !d.params.simulateTouch ? e[0] : t[0],
								move: h.touch || !d.params.simulateTouch ? e[1] : t[1],
								end: h.touch || !d.params.simulateTouch ? e[2] : t[2]
							}
						}(),
						touchEventsData: {
							isTouched: void 0,
			...
			return a.prototype.slidesPerView = function() {
				var e = this,
					t = e.params,
					a = e.slides,
					i = e.slidesGrid,
				...
				a.emit("beforeDestroy"), a.initialized = !1, a.detachEvents(), i.loop && a.loopDestroy(), t && (a.removeClasses(), s.removeAttr("style"), n.removeAttr("style"), r && r.length && r.removeClass([i.slideVisibleClass, i.slideActiveClass, i.slideNextClass, i.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index").removeAttr("data-swiper-column").removeAttr("data-swiper-row")), a.emit("destroy"), Object.keys(a.eventsListeners).forEach(function(e) {
					a.off(e)
				}), !1 !== e && (a.$el[0].swiper = null, a.$el.data("swiper", null), u.deleteProps(a), a = null)
		...
		G = {
			...
			event: r.navigator.userAgent.indexOf("firefox") > -1 ? "DOMMouseScroll" : s() ? "wheel" : "mousewheel",
				...
				if (0 !== s) {
					if (i.invert && (s = -s), a.params.freeMode) {
						var l = a.getTranslate() + s * i.sensitivity,
							d = a.isBeginning,
							c = a.isEnd;
						if (l >= a.minTranslate() && (l = a.minTranslate()), l <= a.maxTranslate() && (l = a.maxTranslate()), a.setTransition(0), a.setTranslate(l), a.updateProgress(), a.updateActiveIndex(), a.updateSlidesClasses(), a.updateRealIndex(), (!d && a.isBeginning || !c && a.isEnd) && a.updateSlidesClasses(), a.params.freeModeSticky && (clearTimeout(a.mousewheel.timeout), a.mousewheel.timeout = u.nextTick(function() {
							a.slideReset()
						}, 300)), a.emit("scroll", t), a.params.autoplay && a.params.autoplayDisableOnInteraction && a.stopAutoplay(), 0 === l || l === a.maxTranslate()) return
					} else {
						if (u.now() - a.mousewheel.lastScrollTime > 60) if (s < 0) if (a.isEnd && !a.params.loop || a.animating) {
			...
			update: function() {
				...
				if (a.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
					...
					if (t.params.loop ? ((i = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > t.slides.length - 1 - 2 * t.loopedSlides && (i -= t.slides.length - 2 * t.loopedSlides), i > n - 1 && (i -= n), i < 0 && "bullets" !== t.params.paginationType && (i = n + i)) : i = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === a.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
						var r = t.pagination.bullets;
						if (a.dynamicBullets && (t.pagination.bulletSize = r.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), s.css(t.isHorizontal() ? "width" : "height", 5 * t.pagination.bulletSize + "px")), r.removeClass(a.bulletActiveClass + " " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " + a.bulletActiveClass + "-prev-prev"), s.length > 1) r.each(function(t, s) {
							var n = e(s);
							...
							var o = r.eq(i);
							o.addClass(a.bulletActiveClass), a.dynamicBullets && (o.prev().addClass(a.bulletActiveClass + "-prev").prev().addClass(a.bulletActiveClass + "-prev-prev"), o.next().addClass(a.bulletActiveClass + "-next").next().addClass(a.bulletActiveClass + "-next-next"))
						}
						if (a.dynamicBullets) {
							var l = (5 * t.pagination.bulletSize - t.pagination.bulletSize) / 2 - i * t.pagination.bulletSize;
							r.css(t.isHorizontal() ? "left" : "top", l + "px")
						}
					}
					if ("fraction" === a.type && (s.find("." + a.currentClass).text(i + 1), s.find("." + a.totalClass).text(n)), "progressbar" === a.type) {
						var d = (i + 1) / n,
							c = d,
							p = 1;
						t.isHorizontal() || (p = d, c = 1), s.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + c + ") scaleY(" + p + ")").transition(t.params.speed)
					}
					"custom" === a.type && a.renderCustom ? (s.html(a.renderCustom(t, i + 1, n)), t.emit("paginationRender", t, s[0])) : t.emit("paginationUpdate", t, s[0])
				}
			},
			render: function() {
				var e = this,
				...
				if (t.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
					var a = e.pagination.$el,
						i = "";
					if ("bullets" === t.type) {
						for (var s = e.params.loop ? Math.ceil((e.slides.length - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length, n = 0; n < s; n += 1) t.renderBullet ? i += t.renderBullet.call(e, n, t.bulletClass) : i += "<" + t.bulletElement + ' class="' + t.bulletClass + '"></' + t.bulletElement + ">";
		...
		j = {
			...
			updateSize: function() {
				...
				if (e.params.scrollbar.el && e.scrollbar.el) {
					...
					var s, n = e.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight,
						...
						o = r * (n / e.size);
					s = "auto" === e.params.scrollbar.dragSize ? n * r : parseInt(e.params.scrollbar.dragSize, 10), e.isHorizontal() ? a[0].style.width = s + "px" : a[0].style.height = s + "px", i[0].style.display = r >= 1 ? "none" : "", e.params.scrollbarHide && (i[0].style.opacity = 0), u.extend(t, {
						trackSize: n,
						divider: r,
						moveDivider: o,
						dragSize: s
			...
			setDragPosition: function(e) {
				var t, a = this,
					...
					l = -a.minTranslate() * r,
					d = -a.maxTranslate() * r;
				o < l ? o = l : o > d && (o = d), o = -o / r, a.updateProgress(o), a.setTranslate(o), a.updateActiveIndex(), a.updateSlidesClasses(), a.updateRealIndex()
			},
			...
			init: function() {
				...
				if (t.params.scrollbar.el) {
					...
					0 === o.length && (o = e('<div class="swiper-scrollbar-drag"></div>'), r.append(o)), t.scrollbar.dragEvents = !1 !== t.params.simulateTouch || h.touch ? s : {
						start: "mousedown",
						move: "mousemove",
						end: "mouseup"
					}, u.extend(a, {
		...
		_ = {
			setTransform: function(t, a) {
				...
				if (l || d ? (l = l || "0", d = d || "0") : i.isHorizontal() ? (l = o, d = "0") : (d = o, l = "0"), l = l.indexOf("%") >= 0 ? parseInt(l, 10) * a * r + "%" : l * a * r + "px", d = d.indexOf("%") >= 0 ? parseInt(d, 10) * a + "%" : d * a + "px", "undefined" != typeof pOpacity && null !== p) {
					var u = p - (p - 1) * (1 - Math.abs(a));
					n[0].style.opacity = u
				}
				if ("undefined" == typeof pScale || null === c) n.transform("translate3d(" + l + ", " + d + ", 0px)");
				else {
		...
		Z = {
			...
			onGestureEnd: function(e) {
				var t = this,
					...
					i = t.zoom,
					s = i.gesture;
				!h.gestures && ("touchend" !== e.type || "touchend" === e.type && e.changedTouches.length < 2) || s.$imageEl && 0 !== s.$imageEl.length && (i.scale = Math.max(Math.min(i.scale, s.maxRatio), a.minRatio), s.$imageEl.transition(t.params.speed).transform("translate3d(0,0,0) scale(" + i.scale + ")"), i.currentScale = i.scale, i.isScaling = !1, 1 === i.scale && (s.$slideEl = void 0))
			},
			onTouchStart: function(e) {
				var t = this.zoom,
					a = t.gesture,
					i = t.image;
				a.$imageEl && 0 !== a.$imageEl.length && (i.isTouched || (S.android && e.preventDefault(), i.isTouched = !0, i.touchesStart.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, i.touchesStart.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY))
			},
			...
			enable: function() {
				...
				if (!a.enabled) {
					a.enabled = !0;
					var i = t.slides,
						s = !("touchstart" !== t.touchEvents.start || !h.passiveListener || !t.params.passiveListeners) && {
							passive: !0,
							capture: !1
						};
					h.gestures ? (i.on("gesturestart", a.onGestureStart, s), i.on("gesturechange", a.onGestureChange, s), i.on("gestureend", a.onGestureEnd, s)) : "touchstart" === t.touchEvents.start && (i.on(t.touchEvents.start, a.onGestureStart, s), i.on(t.touchEvents.move, a.onGestureChange, s), i.on(t.touchEvents.end, a.onGestureEnd, s)), t.slides.each(function(i, s) {
						var n = e(s);
		...
		J = {
			...
			load: function() {
				...
				else if (o > 1) for (var l = n; l < n + o; l += 1) s[l] && t.lazy.loadImagesInSlide(l);
				else t.lazy.loadImagesInSlide(n);
				if (r.loadPrevNext) if (o > 1 || r.loadPrevNextAmount && r.loadPrevNextAmount > 1) {
					for (var d = r.loadPrevNextAmount, c = o, p = Math.min(n + c + Math.max(d, c), s.length), u = Math.max(n - Math.max(c, d), 0), h = n + o; h < p; h += 1) s[h] && t.lazy.loadImagesInSlide(h);
					for (var f = u; f < n; f += 1) s[f] && t.lazy.loadImagesInSlide(f)
				} else {
					var v = a.children("." + i.slideNextClass);
					v.length > 0 && t.lazy.loadImagesInSlide(v.index());
			...
			create: function() {
				...
				u.extend(e, {
					lazy: {
						...
						load: J.load.bind(e),
						loadImagesInSlide: J.loadImagesInSlide.bind(e)
					}
				})
			},
			on: {
		...
		te = {
			...
			setTranslate: function(e, t) {
				function a(e) {
					...
					"slide" === n.params.controller.by && (n.controller.getInterpolateFunction(e), s = -n.controller.spline.interpolate(-t)), s && "container" !== n.params.controller.by || (i = (e.maxTranslate() - e.minTranslate()) / (n.maxTranslate() - n.minTranslate()), s = (t - n.minTranslate()) * i + e.minTranslate()), n.params.controller.inverse && (s = e.maxTranslate() - s), e.updateProgress(s), e.setTranslate(s, n), e.updateActiveIndex(), e.updateSlidesClasses(), e.updateRealIndex()
				}
				var i, s, n = this,
					r = n.controller.control;
				if (Array.isArray(r)) for (var o = 0; o < r.length; o += 1) r[o] !== t && r[o] instanceof L && a(r[o]);
				else r instanceof L && t !== r && a(r)
			},
			setTransition: function(e, t) {
				function a(t) {
				...
				if (Array.isArray(n)) for (i = 0; i < n.length; i += 1) n[i] !== t && n[i] instanceof L && a(n[i]);
		...
		ne = {
			init: function() {
				...
				if (e.params.history) {
					...
					var t = e.history;
					t.initialized = !0, t.paths = ne.getPathValues(), (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || r.addEventListener("popstate", e.history.setHistoryPopState))
				}
			},
			destroy: function() {
				var e = this;
		...
		ue = {
			...
			on: {
				beforeInit: function() {
					var e = this;
					"fade" === e.params.effect && (e.classNames.push(e.params.containerModifierClass + "fade"), u.extend(e.params, {
						slidesPerView: 1,
						slidesPerColumn: 1,
						slidesPerGroup: 1,
						watchSlidesProgress: !0,
						spaceBetween: 0
					}), void 0 === e.passedParams.virtualTranslate && (e.params.virtualTranslate = !0))
				},
				setTranslate: function() {
					var e = this;
			...
			setTranslate: function() {
				...
				for (var h = 0; h < n.length; h += 1) {
					var f = n.eq(h),
						v = 90 * h,
						m = Math.floor(v / 360);
					l && (v = -v, m = Math.floor(-v / 360));
					var g = Math.max(Math.min(f[0].progress, 1), -1),
						b = 0,
						w = 0,
						x = 0;
					h % 4 == 0 ? (b = 4 * -m * d, x = 0) : (h - 1) % 4 == 0 ? (b = 0, x = 4 * -m * d) : (h - 2) % 4 == 0 ? (b = d + 4 * m * d, x = d) : (h - 3) % 4 == 0 && (b = -d, x = 3 * d + 4 * d * m), l && (b = -b), p || (w = b, b = 0);
					var T = "rotateX(" + (p ? 0 : -v) + "deg) rotateY(" + (p ? v : 0) + "deg) translate3d(" + b + "px, " + w + "px, " + x + "px)";
					if (g <= 1 && g > -1 && (u = 90 * h + 90 * g, l && (u = 90 * -h - 90 * g)), f.transform(T), c.slideShadows) {
						...
						0 === E.length && (E = e('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), f.append(E)), 0 === S.length && (S = e('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), f.append(S)), E.length && (E[0].style.opacity = Math.max(-g, 0)), S.length && (S[0].style.opacity = Math.max(g, 0))
					}
				}
				if (s.css({
				...
				var I = y.isSafari || y.isUiWebView ? -d / 2 : 0;
				s.transform("translate3d(0px,0," + I + "px) rotateX(" + (a.isHorizontal() ? 0 : u) + "deg) rotateY(" + (a.isHorizontal() ? -u : 0) + "deg)")
			},
			setTransition: function(e) {
				var t = this,
					a = t.$el;
		...
		fe = {
			...
			on: {
				beforeInit: function() {
					var e = this;
					"cube" === e.params.effect && (e.classNames.push(e.params.containerModifierClass + "cube"), e.classNames.push(e.params.containerModifierClass + "3d"), u.extend(e.params, {
						slidesPerView: 1,
						slidesPerColumn: 1,
						slidesPerGroup: 1,
						watchSlidesProgress: !0,
			...
			setTransition: function(t) {
				...
				if (i.transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t), a.params.virtualTranslate && 0 !== t) {
					...
					i.eq(s).transitionEnd(function() {
						if (!r && a && e(this).hasClass(a.params.slideActiveClass)) {
							r = !0, a.animating = !1;
							for (var t = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], i = 0; i < t.length; i += 1) n.trigger(t[i])
						}
					})
				}
			}
		...
		me = {
			...
			on: {
				beforeInit: function() {
					var e = this;
					"flip" === e.params.effect && (e.classNames.push(e.params.containerModifierClass + "flip"), e.classNames.push(e.params.containerModifierClass + "3d"), u.extend(e.params, {
						slidesPerView: 1,
						slidesPerColumn: 1,
						slidesPerGroup: 1,
						watchSlidesProgress: !0,
		...
		ge = {
			setTranslate: function() {
				...
				y.ie && (n[0].style.perspectiveOrigin = c + "px 50%")
			},
			setTransition: function(e) {
	...
	return L.components = [D, O, N, A, X, B, V, F, q, K, U, Q, ee, ae, se, re, le, ce, ue, fe, me, be], L
});
