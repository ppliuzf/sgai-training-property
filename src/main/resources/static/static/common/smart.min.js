...
$(document).ready(function () {
    ...
    if(!$(".table_fluid .small_btn").length){
        $(".table_infor").css({"float":"none"});
        $(".form-search").css({"float":"none","max-width":"none"});
    }else{
        //清除搜索框的浮动
        if($(".form-search")){
            $(".form-search").after("<div class='clearfix'></div>")
        }else if($(".table_infor")){
            $(".table_infor").after("<div class='clearfix'></div>")
        }
    }
});
