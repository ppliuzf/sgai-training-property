$(function() {
	...
	// 关闭视频
	$('.playHeader').on('click','.closevideo', function() {
		playVideo[0].pause();
		$("#video_row").css("display","none");
		$(".videoModel").css("display","none");
	})
	...
	// 居中显示
	var videoWidth = -$("#video_row").width()/2;
	$("#video_row").css("marginLeft",videoWidth);

	// 图片居中显示
	var imgWidth = -$("#img_row").width()/2;
	$("#img_row").css("marginLeft",imgWidth);
});
...
function videoPlay(e){
  e.stopPropagation();
      // 根据屏幕大小调整视频大小
  var videoWidth = $("body").width()/1.8;
  $("#willesPlay").width(videoWidth);
  $("#video_row").css("display","block");
  $(".videoModel").css("display","block");
}
...
window.onresize = function(){
	var videoWidth = $("body").width()/1.8;
    $("#willesPlay").width(videoWidth);
	var videoLeft = -$("#video_row").width()/2;
	$("#video_row").css("marginLeft",videoLeft);
	// var imgWidth = -$("#img_row").width()/2;
	// $("#img_row").css("marginLeft",imgWidth);
}