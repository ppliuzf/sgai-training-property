    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() <  available_height) {
                ...
                //$("#mainFrame").attr('style', 'min-height:' + (available_height - 48) + 'px');
            }
        } else {
            ...
            if (height >= content.height()) {
                ...
                //$("#mainFrame").attr('style', 'min-height:' + (height - 48) + 'px');
            }else{
                //content.attr('style', 'min-height:' + content.height() + 'px !important');
            }
        }          
    }

    var handleSidebarMenu = function () {
    	 /*jQuery('.page-sidebar').on('contextmenu', 'li > a', function (e) {
    		 e.preventDefault();
    	 });*/
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                parent.children('li.open').children('a').children('.arrow').removeClass('open');
                parent.children('li.open').children('.sub-menu').find('li.open').find('.arrow').removeClass('open');
                parent.children('li.open').children('.sub-menu').find('li.open').children('.sub-menu').slideUp(200);
                parent.children('li.open').children('.sub-menu').find('li.open').removeClass('open');
                parent.children('li.open').children('.sub-menu').slideUp(200);
                parent.children('li.open').removeClass('open');
