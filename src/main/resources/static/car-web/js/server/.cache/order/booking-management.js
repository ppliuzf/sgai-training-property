/*TMODJS:{"version":1,"md5":"b55481ad5fc2e0ac939dd84637e4f728"}*/
template('order/booking-management',function($data,$filename
/*``*/) {
...
$out+='> <a href="./pages/order/my-reservation/details-of-reservation.html?id=';
$out+=$escape(item.id);
$out+='&status=';
