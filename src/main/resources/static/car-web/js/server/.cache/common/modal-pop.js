/*TMODJS:{"version":1,"md5":"074864eafa5081903c520d96162d8dbf"}*/
template('common/modal-pop',function($data,$filename
/*``*/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,size=$data.size,title=$data.title,noIcon=$data.noIcon,$string=$utils.$string,content=$data.content,isCancel=$data.isCancel,$out='';$out+='<div class="modal fade" id="modal-pop" role="dialog"> <div class="modal-dialog modal-';
$out+=$escape(size);
