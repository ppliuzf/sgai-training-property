(function ($) {
    ...
    // localStorage.setItem('token', 'eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJqd3QiLCJpYXQiOjE1MzE0NDQ0NjEsInN1YiI6IntcImNvbU5hbWVcIjpcIueZvem5remhueebrue7hFwiLFwidXNlclR5cGVcIjpcIklcIixcImNvbUNvZGVcIjpcImJhaWx1XCIsXCJ1c2VyTmFtZVwiOlwi5byg5L-K5riFXCIsXCJlbUNvZGVcIjpcInpoYW5nanVucWluXCIsXCJ1c2VySWRcIjpcInVzZXIwMVwiLFwiZGVwdENvZGVcIjpcImhvdXRhaVwifSIsImV4cCI6MTUzMTQ4NzY2MX0.xbEYlFxJBk-hQcsy4BklZEJBV3iPpoBnJ5gZvtBxMaE');
        ...
        dept: function (config) {
            ...
            if (opt.default.length) {
                for (var i in opt.default) {
                    ...
                    items += '<span class="js-multi-select-item item" data-id="'+ opt.default[i].id +'">'+ opt.default[i].title +'</span>';
        ...
        formatTime: function (time, format) {
            ...
            var stamp = new Date(time),
                ...
                ms =
                    stamp.getMilliseconds() < 100 ?
                        "0" +
                        (stamp.getMilliseconds() < 10 ?
                            "0" + stamp.getMilliseconds() :
            ...
            if (format) {
                ...
                if (
                    ...
                    stamp.getMonth() === cur.getMonth() &&
                    stamp.getDate() === cur.getDate()
                ) {
                    // week = '今天';
                }
