/*TMODJS:{"version":1,"md5":"099ff01e36f484b2eade684c473e5f54"}*/
template('plan/device-list',function($data,$filename
/*``*/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$each=$utils.$each,items=$data.items,item=$data.item,$index=$data.$index,$escape=$utils.$escape,$out='';$out+='<div class="pop-device-list"> ';
$each(items,function(item,$index){
$out+=' <div class="form-inline" data-id="';
$out+=$escape(item.id);
$out+='"> <div class="form-group" data-id="';
$out+=$escape(item.id);
$out+='" data-name="';
