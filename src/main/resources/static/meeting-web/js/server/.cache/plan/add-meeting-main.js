/*TMODJS:{"version":1,"md5":"07c7b32dde4020e0bb3015a2ee9cd86e"}*/
template('plan/add-meeting-main',function($data,$filename
/*``*/) {
...
$out+=$escape(rrRoomPeoples);
$out+='人</td>  </tr> <!-- <tr> <td class="text-center" colspan="4" rowspan="2"></td> <td class="text-center"> ';
if(deviceDetailVoList.length>0){
...
$out+=' </td> </tr> --> <!-- <tr> <td class="text-center" colspan="4" rowspan="2"></td> ';
if(deviceDetailVoList.length>0){
$out+=' <td class="text-center"> 已启用：</td> <td class="value text-center"> ';
$each(deviceDetailVoList,function(itom,$index){
$out+=' ';
if(itom.rdsState==0){
$out+=' <span href="javascript:;" class="device-txt" data-rdsId="';
...
$out+=' </td> </tr> <tr> <td class="text-center"> 已禁用：</td> <td class="value text-center"> ';
$each(deviceDetailVoList,function(itom,$index){
if(itom.rdsState!=0){
$out+=' <span href="javascript:;" class="device-txt" data-rdsId="';
$out+=$escape(itom.rdsId);
...
$out+=' --> <tr> <td class=" text-center" rowspan="2">会议室设备：</td>  ';
if(deviceDetailVoList.length>0){
...
$out+=' ';
if(deviceDetailVoList.length == 0){
$out+=' <tr> <td colspan="2" class="value" style="text-align: center">无</td> </tr> ';
}
