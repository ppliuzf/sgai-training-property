(function ($) {
    var $_GET = (function () {    
        ...
        // else {
        //     var tokens = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJqd3QiLCJpYXQiOjE1Mjk3MjYwODgsInN1YiI6IntcImNvbU5hbWVcIjpcIuWIm-aWsOS4reW_g1wiLFwidXNlclR5cGVcIjpcIklcIixcImNvbUNvZGVcIjpcInNrMDAxXCIsXCJ1c2VyTmFtZVwiOlwi5p2O5ri45LidXCIsXCJlbUNvZGVcIjpcInNrdXNlcjEwXCIsXCJ1c2VySWRcIjpcInNrdXNlcjEwXCIsXCJkZXB0Q29kZVwiOlwiVUljc1wifSIsImV4cCI6MTUyOTc2OTI4OH0.mjE-rRHpSweKp01LIOG44FLpBqNcqVq1wLnCMH8H3Ok";
            ...
            $(opt.el).each(function() {
                ...
                if (opt.default.length) {
                    for (var i in opt.default) {
                        if (opt.default[i].indexOf(';')>-1){
                            opt.default[i].substring(1,opt.default[i].length-1);
        ...
        instantSearch: function (config) {
            ...
            $(opt.el).each(function () {
                $(this).html(template('common/instant-search', {
                    ...
                    approvalEmpName: opt.approvalEmpName,
                    approvalEmpId: opt.approvalEmpId
                }));
                var $this = $(this),
