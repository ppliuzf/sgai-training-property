/*TMODJS:{"version":36,"md5":"873808faf305eb76a7e6e77e3b2eedcd"}*/
template('check/detail-check',function($data,$filename
/**/) {
'use strict';var $utils=this,$helpers=$utils.$helpers,$escape=$utils.$escape,items=$data.items,$each=$utils.$each,item=$data.item,$index=$data.$index,$out='';$out+='<div class="row header"> <h4>';
$out+=$escape(items.tiName);
$out+='</h4> <div class="btns text-right"> <button type="button" class="btn btn-default btn-back js-check-back">返回</button> </div> </div> <h4>基础信息:</h4> <div class="row"> <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> <div class="row"> <div class="col-sm-4 col-md-3"> <dl> <dt>检验项名称:</dt> <dd>';
$out+=$escape(items.tiName);
...
$out+='</dd> </dl> </div> </div> </div> </div> <h4>检验标准:</h4> <div class="row"> <div class="col-sm-12 col-md-12 desc">';
...
$out+=' <h4>缺陷整改:</h4> <div class="row"> <div class="col-sm-4 col-md-3"> <dl> <dt>责任岗位:</dt> <dd>';
...
$out+=' </dd> </dl> </div> <div class="col-sm-4 col-md-3"> <dl> <dt>整改要求:</dt> <dd class="desc">';
